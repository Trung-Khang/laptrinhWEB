        ...
        <main class="main-content">
            <div class="card mx-auto" style="max-width:800px;">
                <div class="card-header">
                    <h5 class="mb-0 fw-semibold"><i class="fa-solid fa-plus me-2 text-primary"></i>Thông tin danh mục</h5>
                </div>
                <div class="card-body p-4">
                    <form action="${pageContext.request.contextPath}/admin/category/add" method="post" enctype="multipart/form-data">
                        <div class="mb-3">
                            ...
                            <input type="text" id="cateName" name="name" class="form-control" placeholder="Ví dụ: Điện thoại, Laptop..." required />
                        </div>

                        <div class="mb-4">
                            <label for="cateIcon" class="form-label">Icon</label>
                            <input type="file" id="cateIcon" name="icon" class="form-control" accept="image/*" />
                            <div class="form-text">Hỗ trợ định dạng JPG, PNG, GIF...</div>
                        </div>
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="${pageContext.request.contextPath}/admin/category/list" class="btn btn-outline-secondary btn-icon">
